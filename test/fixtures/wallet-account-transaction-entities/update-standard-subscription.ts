import {WalletAccountTransactionEntityUpdateStandardSubscription} from '../../../src';

export default {
  objectType: 'walletAccountTransactionEntity',
  operationType: 'UPDATE',
  objectValue: {
    accountTransactionId: '7877376470',
...
} as WalletAccountTransactionEntityUpdateStandardSubscription;
